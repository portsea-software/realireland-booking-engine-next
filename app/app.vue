					...
					<div class="col-md-6">
						<span class="d-flex align-items-center mb-1">
							...
							<a
								class="ms-1"
								:href="mailTo"
							>Email Luxury European Tours Ltd</a>
						</span>
						<span class="d-flex align-items-center mb-1">
							...
							<a
								class="ms-1"
								:href="tel"
							>Call Luxury European Tours Ltd</a>
						</span>
						<span class="d-flex align-items-center mb-1">
							<Icon name="i-lucide:earth" /> <a
								class="ms-1"
								href="https://www.luxuryeuropeantours.com"
							>Visit luxuryeuropeantours.com</a>
						</span>
					</div>
				</div>
